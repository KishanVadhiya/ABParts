const controlValveSpareModel= require('../models/controlValveSpareModel')


const getParts = async (req,res)=>{
    try {
        const parts = await controlValveSpareModel.getParts();
...
const addPart = async (req, res) => {
    ...
    try {
        const result = await controlValveSpareModel.addPart(partDetails);
...
const updatePart = async (req, res) => {
    ...
    try {
        const result = await controlValveSpareModel.updatePart(sr_no, updatedDetails);
...
const deletePart = async (req, res) => {
    ...
    try {
        const result = await controlValveSpareModel.deletePart(sr_no);
